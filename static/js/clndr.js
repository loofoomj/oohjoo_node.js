    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            "<div class='clndr-control-button'>" +
                "<span class='clndr-previous-button' data-prevmonth='<%= month %>'><i class='material-icons'>&#xE037;</i></span>" +
            "</div>" +
            "<div class='month'><%= month %> <%= year %></div>" +
            "<div class='clndr-control-button rightalign'>" +
                "<span class='clndr-next-button' data-nextmonth='<%= month %>'><i class='material-icons'>&#xE037;</i></span>" +
            "</div>" +
        "</div>" +
        "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
            ...
            "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                ...
                "<% for(var j = 0; j < 7; j++){ %>" +
                "<% var d = j + i * 7; %>" +
                    "<td class='<%= days[d].classes %>' data-thisDate='<%= days[d].date %>'>" +
                        "<div class='day-contents'><%= days[d].day %></div>" +
                        "<div class='day-contents-time-stamp' style='text-align:right;'>" +
                        "<i class='material-icons complete-<%= days[d].date %>' style='margin-right: 5px;color: #FF5E88;display:none;''>&#xE1AD;</i>" +
                        "<i class='material-icons incomplete-<%= days[d].date %>' style='margin-right: 5px;color: #149ECC;display:none;''>&#xE1AD;</i>" +
                        "</div>" +
                    "</td>" +
                "<% } %>" +
                "</tr>" +
